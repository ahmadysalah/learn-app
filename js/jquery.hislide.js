    ...
    var slide = function (ele, options) {
        var states =
            ((window.innerWidth <= 700)) ? [
                ...
                { $zIndex: 2, width: 130, height: 170, top: 59, left: 0, $opacity: 0.4, $opacityText: 0 },
                { $zIndex: 3, width: 170, height: 218, top: 35, left: 110, $opacity: 0.7, $opacityText: 0 },
                { $zIndex: 4, width: 224, height: 288, top: 0, left: 263, $opacity: 1, $opacityText: 1 },
                { $zIndex: 3, width: 170, height: 218, top: 35, left: 470, $opacity: 0.7, $opacityText: 0 },
                { $zIndex: 2, width: 130, height: 170, top: 59, left: 620, $opacity: 0.4, $opacityText: 0 },
                { $zIndex: 1, width: 120, height: 150, top: 69, left: 740, $opacity: 0.2, $opacityText: 0 }
            ];
        var $ele = $(ele);
        var setting = {
            speed: 1000,
